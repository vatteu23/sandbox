...
const About = () => {
  return (
    <Layout className="bg-white dark:bg-neutral-950 min-h-screen">
      ...
      <div className="pt-32 pb-16 md:pt-40 md:pb-20 border-b border-neutral-100 dark:border-neutral-900">
        <Container>
          ...
          <p className="text-lg text-neutral-600 dark:text-neutral-300 max-w-xl leading-relaxed mb-8">
            I build things for the web and photograph cars on weekends. Both are
            about noticing what makes something worth looking at.
          </p>
      ...
      {/* Main content */}
      <Container>
        <div className="py-20 md:py-24 flex flex-col md:flex-row gap-y-12 md:gap-x-6 lg:gap-16">
          {/* Sidebar */}
          <div className="md:sticky md:top-[90px] w-full md:w-1/3 lg:w-1/4 h-fit rounded-lg overflow-hidden border border-neutral-100 dark:border-neutral-800">
            <div className="bg-neutral-50 dark:bg-neutral-900 overflow-hidden border-b border-neutral-100 dark:border-neutral-800">
              ...
              <div className="p-4 pt-3">
                <p className="text-sm font-semibold text-neutral-900 dark:text-neutral-100 font-mono mb-0.5">
                  Uday Vatti
                </p>
          ...
          {/* Story */}
          <div className="md:w-2/3 lg:w-3/4 max-w-xl space-y-12">
            {/* The story */}
            <div className="space-y-6">
              <p className="text-[1.0625rem] text-neutral-700 dark:text-neutral-200 leading-[1.8]">
                I started out building things for the web — backends, databases,
                eventually UIs. At some point I got obsessed with the part that
                most engineers hand off: the last mile between a design file and
                what a real person actually uses. That gap is where I've lived
                ever since.
              </p>
              ...
              <p className="text-[1.0625rem] text-neutral-600 dark:text-neutral-300 leading-[1.8]">
                What drives me is the belief that great products don't come from
                design and engineering working in sequence — they come from
                people who can hold both at the same time. I've built things
                that looked good but didn't work, and things that worked but
                felt wrong. The goal is always both.
              </p>
            </div>
            ...
            <div>
              ...
              <div className="space-y-5">
                <p className="text-[1.0625rem] text-neutral-600 dark:text-neutral-300 leading-relaxed">
                  ...
                  special and others don't despite the same spec sheet. It's the
                  same question I ask about software.
                </p>
                <p className="text-[1.0625rem] text-neutral-600 dark:text-neutral-300 leading-relaxed">
            ...
            <div className="border-t border-neutral-100 dark:border-neutral-800 pt-10">
              <p className="text-[1.0625rem]text-neutral-500 dark:text-neutral-400 leading-relaxed mb-6">
                If you're building something where the design and the code both
                need to be right — I'd like to hear about it.
              </p>
              <a
                href="https://www.linkedin.com/in/vattiu/"
                target="_blank"
