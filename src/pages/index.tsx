    ...
    <Layout className="bg-zinc-100">
      ...
      <div className="relative h-[90vh] max-h-[1400px] bg-orange-500">
        <Container className="py-12 h-full flex justify-center items-center">
          <div className="grid grid-cols-12">
            <div
              className="col-span-12 sm:col-span-6 text-left flex items-center order-1 md:order-2"
              ref={component}
            >
              <div>
                <Typography
                ...
                >
                  ...
                  <Link
                    className="bg-amber-300 text-neutral-900 transition-all duration-300 ease-in-out px-2 py-1 hover:py-2"
      ...
      <Container className="py-12">
        <Typography
          fontWeight="bold"
          variant="h5"
          className="text-left text-orange-500 mb-4"
        >
          ABOUT ME
        </Typography>
        <Typography
        ...
        >
          <b>Web developer. Photographer. Car enthusiast.</b> I craft clean,
          user-friendly web experiences and capture timeless portraits.
          Passionate about creating something special?{" "}
          <Link
            href="https://www.linkedin.com/in/vattiu/"
            className="bg-amber-300 transition-all duration-300 ease-in-out px-2 py-1 hover:py-2"
          >
            Let's chat.
          </Link>
        </Typography>
      ...
      <Container className="py-12 md:py-24">
        <Typography
          fontWeight="bold"
          variant="h5"
          className="text-orange-500 text-left mb-4"
        >
          EXPERIENCE
        </Typography>
          ...
          {Porjects.map((project: PorjectProps, index: number) => {
            return (
              <div
                ...
                className="group cursor-pointer col-span-12 hover:-translate-y-1 
            hover:-translate-x-1
            transform 
                ...
                <div className="grid grid-cols-3 max-w-3xl gap-x-6 ">
                  <div className="year col-span-2 md:col-span-1 order-2 md:order-1">
                    <Typography
                      variant="p"
                      fontWeight="bold"
                      className="my-2 group-hover:bg-amber-300
                  ...
                  <div className="details col-span-3 md:col-span-2 flex flex-row order-1 md:order-2">
                    ...
                    <div className="">
                      <Typography
                        ...
                        fontWeight="bold"
                        color="dark"
                        className="my-2 group-hover:text-zinc-500"
                      >
                        {project.name}
                      </Typography>
                      <Typography
      ...
      <Container className="py-12 md:py-24">
        <Typography
          fontWeight="bold"
          variant="h5"
          className="text-left mb-4 text-orange-500"
        >
          FREELANCE PROJECTS
        </Typography>
        <div className="grid grid-cols-12 gap-6">
